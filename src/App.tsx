...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      {/* Main Content Area */}
      <main className="flex-1 max-w-[1600px] w-full mx-auto p-2 sm:p-4 md:p-5">
        ...
        <div className="no-print mb-4 bg-white px-3 sm:px-4 py-2.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 text-xs">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="flex-1 sm:flex-initial px-3 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-2xs min-h-[38px]"
            >
            ...
            <button
              ...
              className="px-2.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer border border-slate-200 min-h-[38px]"
            ...
            >
              ...
              <span className="sm:hidden">Salin Plan</span>
            </button>
          </div>
        </div>
