    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col justify-between">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-slate-500">SPV Lapor</span>
        </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col justify-between">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-slate-500">orang tertunda</span>
        </div>
        <div className="mt-2 text-[11px] text-slate-500 truncate">
          {todayUnreported === 0 ? 'Semua plan harian terpenuhi' : 'Perlu difollow up ke PIC'}
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col justify-between">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          ...
          <span className="text-xs text-slate-500">tanda merah</span>
        </div>
        <div className="mt-2 text-[11px] text-slate-500 truncate">
          {todayProblem > 0 ? 'Catatan kendala pada tanggal ini' : 'Operasional berjalan lancar'}
        </div>
      </div>
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs flex flex-col justify-between">
        ...
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-black text-slate-800">{totalMonthReported}</span>
          <span className="text-xs text-slate-500">/ {totalMonthPlanned} plan</span>
        </div>
        <div className="mt-2 text-[11px] text-slate-500 flex items-center justify-between">
          <span>Kepatuhan Kumulatif</span>
          <span className="font-bold text-teal-700">{monthCompliance}%</span>
        </div>
      </div>
    </div>
  );
