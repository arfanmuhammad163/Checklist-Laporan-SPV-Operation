      ...
      {isExpanded && (
        <div className="space-y-3 animate-in slide-in-from-top-2 fade-in duration-200">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 shadow-xs space-y-3.5">
            ...
            {/* Controls Row - Responsive Stack on Mobile, Flex on Desktop */}
            <div className="space-y-2.5">
              {/* Row 1 on mobile: Status pill & Buka Sheets */}
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 text-emerald-700 border border-emerald-300 rounded-full font-bold text-xs shrink-0">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 rounded-xl text-xs font-semibold transition-all cursor-pointer shrink-0 min-h-[36px]"
              ...
              {/* Row 2: URL Display / Input Box */}
              <div className="flex items-center gap-2 w-full bg-amber-50/50 border border-amber-200/90 rounded-xl px-3 py-1.5 min-h-[42px]">
                ...
                <input
                  ...
                  className={`flex-1 text-xs font-mono text-slate-700 bg-transparent focus:outline-none truncate min-w-0 ${
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-slate-600 hover:text-slate-900 bg-white hover:bg-slate-100 border border-slate-200 rounded-lg shrink-0 transition-colors cursor-pointer min-h-[32px]"
              ...
              {/* Row 3: Action Buttons (2-column on mobile, auto-width on tablet/desktop) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-center gap-2">
                <button
                  type="button"
                  disabled={isSyncing}
                  onClick={handleTriggerSync}
                  className="flex items-center justify-center gap-2 px-4 py-2.5 bg-[#00875A] hover:bg-[#00704A] text-white rounded-xl text-xs sm:text-sm font-bold shadow-xs transition-all active:scale-95 cursor-pointer disabled:opacity-50 min-h-[44px]"
                ...
                {onPullFromSheet && (
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 px-3.5 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-95 cursor-pointer disabled:opacity-50 min-h-[44px]"
